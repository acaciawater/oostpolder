"""
Django settings for oostpolder project.
...
#        'DIRS': ['/home/theo/texelmeet/oostpolder/oostpolder/templates'],
        'DIRS': [],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'oostpolder.wsgi.application'
...
GRAPPELLI_ADMIN_TITLE='Beheer van Oostpolder Meet'
...
LOGGING = {
    ...
    'handlers': {
        'file': {
            ...
            'filename': os.path.join(LOGGING_ROOT, 'oostpolder.log'),
            'when': 'D',
